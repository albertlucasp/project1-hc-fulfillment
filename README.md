...
(dbt transformation layer and Power BI dashboard sections pending)

Orchestration (Airflow) is being hand-built, in progress - see
[docs/airflow_setup.md](docs/airflow_setup.md) for the step-by-step build
log and reasoning.
